...
func (x *AvgRequest) Reset() {
	*x = AvgRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_number_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AvgRequest) Descriptor() ([]byte, []int) {
	return file_number_proto_rawDescGZIP(), []int{4}
}
...
func (x *AvgResponse) Reset() {
	*x = AvgResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_number_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AvgResponse) Descriptor() ([]byte, []int) {
	return file_number_proto_rawDescGZIP(), []int{5}
}
...
func (x *SqrtRequest) Reset() {
	*x = SqrtRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_number_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SqrtRequest) Descriptor() ([]byte, []int) {
	return file_number_proto_rawDescGZIP(), []int{8}
}
...
func (x *SqrtResponse) Reset() {
	*x = SqrtResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_number_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SqrtResponse) Descriptor() ([]byte, []int) {
	return file_number_proto_rawDescGZIP(), []int{9}
}
...
var file_number_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a,
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x26, 0x0a, 0x0c, 0x50, 0x72, 0x69, 0x6d, 0x65,
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x24, 0x0a, 0x0a, 0x41, 0x76, 0x67, 0x52,
	...
	0x6c, 0x74, 0x22, 0x25, 0x0a, 0x0b, 0x53, 0x71, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x67, 0x61, 0x66, 0x72, 0x69, 0x70, 0x75, 0x74, 0x72, 0x61, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d,
	0x75, 0x64, 0x65, 0x6d, 0x79, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72,
...
var file_number_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_number_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_number_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_number_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_number_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_number_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
